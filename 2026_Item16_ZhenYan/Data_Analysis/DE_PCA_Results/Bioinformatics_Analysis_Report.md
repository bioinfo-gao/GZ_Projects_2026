...
Date: 2026-06-04 Project: 2026_Item16_ZhenYan

## 1. Overview

This report summarizes the differential expression analysis and quality control metrics for the RNA-seq dataset. - **Analysis Tool**: DESeq2 - **Normalization**: VST (Variance Stabilizing Transformation) for PCA/Heatmap, Median-of-ratios for DE - **Significance Thresholds**: padj \< 0.05, \|log2FoldChange\| \>= 0.585
